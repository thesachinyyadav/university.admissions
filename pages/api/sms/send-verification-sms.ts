...
const VERIFICATION_TEMPLATE = `Hello {{name}},

Your skill assessment and document verification are now complete.

Please proceed to the interview process at CHRIST (Deemed to be University).
...
export default async function handler(
  ...
  try {
    ...
    const message = VERIFICATION_TEMPLATE.replace('{{name}}', name.trim());
